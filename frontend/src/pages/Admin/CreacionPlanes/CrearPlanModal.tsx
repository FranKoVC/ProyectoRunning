  ...
  const toggleEmpresaSelection = (empresaId: string) => {
    ...
    if (isSelected) {
      setFormData({
        ...
        beneficiosSeleccionados: formData.beneficiosSeleccionados.filter(b => !empresas.find(e => e.id === empresaId)?.beneficios.some(be => be.id === b)),
      });
    } else {
      setFormData({
        ...formData,
      ...
      >
        <div className="p-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-bold text-gray-800">Crear Nuevo Plan</h2>
            <button 
              onClick={onClose}
